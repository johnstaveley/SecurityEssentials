...
namespace SecurityEssentials.Unit.Tests.Core
{
    ...
    {
        private readonly string _applicationName = "Security Essentials";

        private readonly string _firstName = "John";
        private readonly string _lastName = "Staveley";
        private readonly string _newEmailAddress = "new@new.com";
        private readonly string _oldEmailAddress = "old@old.com";
        private readonly string _token = "c4f32838-9ab4-46d8-bc49-d080264bd13e";
        private readonly string _url = "http://localhost:4986/";
        ...
        {
            // Act
            var emailText = EmailTemplates.ChangeEmailAddressCompletedBodyText(_firstName, _lastName, _applicationName,
                _oldEmailAddress, _newEmailAddress);

            Assert.AreEqual(
                "Dear John Staveley,<br /><br />A request has been completed to change your Security Essentials username/email address from old@old.com to new@new.com. This email address can no longer be used to sign into the account. If you did not request this then please contact the website administration asap.<br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Security Essentials member\". Emails from Security Essentials will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_GetChangePasswordCompletedBodyText_Then_CorrectEmailIsReturned()
        {
            ...
            Assert.AreEqual(
                "Dear John Staveley,<br /><br />Just a note from Security Essentials to say your password has been changed today, if this wasn't done by yourself, please contact the site administrator asap<br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Security Essentials member\". Emails from Security Essentials will always contain your full name.<br />",
                emailText);
        }
        ...
        public void When_GetChangeSecurityInformationCompletedBodyText_Then_CorrectEmailIsReturned()
        {
            // Act
            var emailText =
                EmailTemplates.ChangeSecurityInformationCompletedBodyText(_firstName, _lastName, _applicationName);

            Assert.AreEqual(
                "Dear John Staveley,<br /><br />Please be advised that the security information on your Security Essentials account been changed. If you did not initiate this action then please contact the site administrator as soon as possible<br />How do I know this is not a Spoof email? Spoof or ‘phishing’ emails tend to have generic greetings such as \"Dear Security Essentials member\". Emails from Security Essentials will always contain your full name.<br />",
                emailText);
        }
    }
}