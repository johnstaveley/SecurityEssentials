...
namespace SecurityEssentials.Controllers
{
    ...
    public class UserController : SecurityControllerBase
    {
        ...
        private ISEContext Context { get; }
        ...
        public ActionResult Edit(int id)
        {
            ...
            return View(new UserViewModel(UserIdentity.GetUserId(this), UserIdentity.IsUserInRole(this, "Admin"),
                user));
        }
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
            ...
            if (users.ToList().Count == 0) return new HttpNotFoundResult();
            var user = users.FirstOrDefault();
            var isOwnProfile = user.Id == UserIdentity.GetUserId(this);
            ...
            if (UserIdentity.IsUserInRole(this, "Admin") && !isOwnProfile)
            ...
            if (TryUpdateModel(user, "User", propertiesToUpdate.ToArray(), collection))
                ...
                {
                    Context.SaveChanges();
                    if (UserIdentity.IsUserInRole(this, "Admin"))
            ...
            return View("Edit",
                new UserViewModel(UserIdentity.GetUserId(this), UserIdentity.IsUserInRole(this, "Admin"), user));
        }
        ...
        {
            return View(new UsersViewModel(UserIdentity.GetUserId(this)));
        }
