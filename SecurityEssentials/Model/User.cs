...
namespace SecurityEssentials.Model
{
	...
	public class User : IUser<int>
    {
		...
		/// </summary>
		[MaxLength(200), Required, MinLength(7), Display(Name="Email Address"), RegularExpression(@"^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$", ErrorMessage="The {0} does not appear to be valid"), Index(IsUnique = true)]
