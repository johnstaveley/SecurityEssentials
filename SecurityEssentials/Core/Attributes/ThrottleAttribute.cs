...
namespace SecurityEssentials.Core.Attributes
{
    ...
    public class AllowXRequestsEveryXSecondsAttribute : ActionFilterAttribute
    {
        ...
        ///     show this.Seconds in the message, e.g. "You have performed this action more than {x} times in the last {n}
        ///     seconds.".
        /// </summary>
        public string Message { get; set; }

        /// <summary>
        ///     The content name (themed and from SiteContent) to show upon throttling.  If this is present, the Message parameter
        ///     will not be used.
        /// </summary>
