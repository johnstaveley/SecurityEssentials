...
namespace SecurityEssentials.Core.Identity
{
    public class UserIdentity : IUserIdentity
    {
        ...
        public Requester GetRequester(Controller controller,
            AppSensorDetectionPointKind? appSensorDetectionPointKind = null)
        {
            return new Requester
            {
                ...
                SessionId = controller.HttpContext.Session == null
                    ? ""
                    : GetHashSha256(controller.HttpContext.Session.SessionID)
            };
        }
