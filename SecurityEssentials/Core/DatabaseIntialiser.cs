...
namespace SecurityEssentials.Core
{
    public class SEDatabaseIntialiser : DropCreateDatabaseAlways<SEContext>
    {
        protected override void Seed(SEContext context)
        {
            ...
            const string standardPasswordHash =
            ...
            context.User.Add(new User
            {
                ...
                Enabled = true,
                FirstName = "Admin",
                HashStrategy = HashStrategyKind.PBKDF2_5009Iterations,
                LastName = "User",
            ...
            {
                Id = 1,
                Description = "Bad passwords"
            }); // SECURE: I've only included passwords which comply with the password policy (ignorning case)
            context.LookupType.Add(new LookupType
            {
                Id = 2,
                Description = "Security Questions"
            }); // SECURE: I've included some sample security questions which are difficult to obtain from the public domain
            ...
            // Security Questions
            context.LookupItem.Add(new LookupItem
            {
                Id = 271,
                Description = "What is the name of your first pet?",
                LookupTypeId = 2,
                Ordinal = 2
            });
            context.LookupItem.Add(new LookupItem
            ...
            {
                Id = 273,
                Description = "What is the name of the first person you kissed?",
                LookupTypeId = 2,
                Ordinal = 4
            });
            context.LookupItem.Add(new LookupItem
            ...
            {
                Id = 275,
                Description = "What was your favourite childhood film?",
                LookupTypeId = 2,
                Ordinal = 5
            });
