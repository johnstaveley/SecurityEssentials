	...
	public class HttpHeaders : IHttpModule
	{
		...
		private void Context_PreSendRequestHeaders(object sender, EventArgs e)
		{
			...
			HttpContext.Current.Response.Headers.Add("Public-Key-Pins", "max-age=0; includeSubDomains"); // Remove public key pinning for debug
																										 //HttpContext.Current.Response.Headers.Add("Public-Key-Pins-Report-Only", "pin-sha256=\"cUPcTAZWKaASuYWhhneDttWpY3oBAkE3h2+soZS7sWs=\"; pin-sha256=\"M8HztCzM3elUxkcjR2S5P4hhyBNf6lHkmjAHKhpGPWE=\"; max-age=1000; includeSubDomains; report-uri /Security/HpkpReporting");
#else
