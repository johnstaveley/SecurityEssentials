...
namespace SecurityEssentials.Core
{
	...
	public class HttpHeaders : IHttpModule
	{
		...
		void context_PreSendRequestHeaders(object sender, EventArgs e)
		{
			...
			HttpContext.Current.Response.Headers.Add("Content-Security-Policy", "default-src 'none'; script-src 'self'; style-src 'self'; img-src 'self'; font-src 'self'"); // SECURE: Tells the browser what content it should run and from where, if you use CDNs you will need to amend this
#if !DEBUG
